...
// ----- GPRS CONFIGURATION -----
const char* GPRS_APN = "";  // APN (kosong untuk auto-detect)
const char* GPRS_USER = ""; // Username GPRS
const char* GPRS_PASS = ""; // Password GPRS

// ----- SERIAL CONFIGURATION -----
const unsigned long MODEM_BAUD_RATE = 115200;
