...
#define ENABLE_DYNAMIC_GPS_INTERVAL
  ...
  #define GPS_SEND_INTERVAL_MOVING 1000      // 1 second when moving
  #define GPS_SEND_INTERVAL_STATIC 3000      // 3 seconds when static (was 10000)
  #define MOVEMENT_SPEED_THRESHOLD 1.0       // 1 km/h threshold (was 0.0)
...
// 4. Dynamic GPS: 1 detik saat moving, 3 detik saat static
...
// - Realtime tracking dengan interval 1-3 detik
