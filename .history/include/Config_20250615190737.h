// Config.h - Modified for Vehicle Endpoint Focus (HTTP)
...
#define SERVER_PORT 80                 // Changed to 80 for HTTP
...
// Add new
#define API_BASE_URL "http://vehitrack.my.id/directus" // Updated to HTTP
