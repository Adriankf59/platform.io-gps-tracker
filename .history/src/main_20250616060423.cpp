// ========================================
// Main.cpp - Modified for WebSocket Implementation
// ========================================

/**
 * ESP32 Vehicle Tracking with WebSocket
...
#include "WebSocketManager.h" // New WebSocket manager
...
WebSocketManager wsManager(&gsmClient); // New WebSocket manager
...
void setup() {
  ...
  LOG_INFO(MODULE_MAIN, "Version: 3.0 (WebSocket Implementation)");
...
void handleOperationalState() {
  ...
  // WebSocket will handle relay updates automatically via subscription
}
...
// ----- MOVEMENT DETECTION (sama seperti sebelumnya) -----
void updateMovementDetection() {
